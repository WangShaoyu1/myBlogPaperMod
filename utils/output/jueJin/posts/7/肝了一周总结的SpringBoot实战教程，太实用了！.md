...
date: 2020-11-25
description: "Spring作为J2EE的轻量级代替品，让我们无需开发重量级的Enterprise JavaBean（EJB），通过依赖注入和面向切面编程，使用简单的Java对象（POJO）即可实现EJB的功能。 虽然Spring的组件代码是轻量级的，但它的配置却是重量级的。即使后来Sprin…"
tags: ["Java","Spring Boot中文技术社区","前端开发社区","前端技术交流","前端框架教程","JavaScript 学习资源","CSS 技巧与最佳实践","HTML5 最新动态","前端工程师职业发展","开源前端项目","前端技术趋势"]
ShowReadingTime: "阅读8分钟"
weight: 1
selfDefined:"likes:125,comments:5,collects:295,views:16218,"
---
...
![](/images/jueJin/87758a4870f8486.png)

*   然后选择通过`Spring Initializr`来创建一个SpringBoot应用；

![](/images/jueJin/fbe2409347354ed.png)

*   填写好Maven项目的`groupId`和`artifactId`及选择好Java版本；

![](/images/jueJin/d88aa02910b74af.png)

*   选择好起步依赖，这里选择的是开启Web功能的起步依赖；

![](/images/jueJin/5b102e62f47149b.png)

*   选择好项目的存放位置即可顺利创建一个SpringBoot应用。

![](/images/jueJin/09471bbfe73e407.png)
...
![](/images/jueJin/99ef1de452744ba.png)
...
描述应用程序上下文里全部的Bean，以及它们之间关系

/conditions

GET

描述自动配置报告，记录哪些自动配置生效了，哪些没生效
...
*   直接访问根端点，可以获取到所有端点访问路径，根端点访问地址：[http://localhost:8088/actuator](https://link.juejin.cn?target=http%3A%2F%2Flocalhost%3A8088%2Factuator "http://localhost:8088/actuator")
...
*   通过`/beans`端点，可以获取到Spring应用上下文中的Bean的信息，比如Bean的类型和依赖属性等，访问地址：[http://localhost:8088/actuator/beans](https://link.juejin.cn?target=http%3A%2F%2Flocalhost%3A8088%2Factuator%2Fbeans "http://localhost:8088/actuator/beans")
...
*   需要添加指标名称才能获取对应的值，比如获取当前JVM使用的内存信息，访问地址：[http://localhost:8088/actuator/metrics/jvm.memory.used](https://link.juejin.cn?target=http%3A%2F%2Flocalhost%3A8088%2Factuator%2Fmetrics%2Fjvm.memory.used "http://localhost:8088/actuator/metrics/jvm.memory.used")
...
*   比如说我们想自定义Actuator端点的基础路径，比如改为`/monitor`，这样我们我们访问地址就变成了这个：[http://localhost:8088/monitor](https://link.juejin.cn?target=http%3A%2F%2Flocalhost%3A8088%2Fmonitor "http://localhost:8088/monitor")
...
[github.com/macrozheng/…](https://link.juejin.cn?target=https%3A%2F%2Fgithub.com%2Fmacrozheng%2Fmall-learning%2Ftree%2Fmaster%2Fmall-tiny-boot "https://github.com/macrozheng/mall-learning/tree/master/mall-tiny-boot")
