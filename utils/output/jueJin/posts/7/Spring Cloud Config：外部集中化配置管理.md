...
*   访问[http://localhost:8901/dev/config-dev.yml](https://link.juejin.cn?target=http%3A%2F%2Flocalhost%3A8901%2Fdev%2Fconfig-dev.yml "http://localhost:8901/dev/config-dev.yml")来获取dev分支上dev环境的配置文件信息:
