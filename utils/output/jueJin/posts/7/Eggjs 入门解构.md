...
数据 dataList 先写死，后续用 service 替换。 `this.ctx.render('news/list.tpl', dataList)`这里是模板与数据的结合。
...
下图可以看得更清晰，可以看到起了 8 个`app_worker.js`, 一个`agent_work.js`, 还有一个 master 进程 ![egg_progress](/images/jueJin/b4609621aa4c4d2.png)
