...
*   通过网关访问API服务，`不带Token`调用获取用户信息的接口，无法正常访问，访问地址：[http://localhost:9201/api/user/info](https://link.juejin.cn?target=http%3A%2F%2Flocalhost%3A9201%2Fapi%2Fuser%2Finfo "http://localhost:9201/api/user/info")
